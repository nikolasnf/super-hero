...
class BrokerageInfo extends PureComponent {
  state = {
    ...
    return (
      <Card>
        <CardBody>
          <Container>
            <FormTitle
              title={<IntlMessages id="menu.corretagem" />}
              className="mb-2"
            />
            ...
            <ModalConfirmation
              ...
              onClick={() => {
                this.props.acceptAdRequest(data?.id);
                this.props.history.push(`/app/agency/agent/brokerage`);
            ...
            <ModalConfirmation
              ...
              onClick={() => {
                this.props.removeAdRequest(data?.id);
                this.handleShowRemoveModal();
                this.props.history.push(`/app/agency/agent/brokerage`);
              }}
            />
...
export default connect(mapStateToProps, mapActionsToProps)(BrokerageInfo);
