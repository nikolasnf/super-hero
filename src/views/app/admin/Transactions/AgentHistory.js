...
import { fetchAgentsTransaction } from '../../../../redux/transaction/actions';
...
class AgentHistory extends Component {
  ...
  componentDidMount() {
    ...
    this.props.fetchAgentsTransaction();
  }
                ...
                >
                  ...
                  >
                    <h4 className={classNames('mb-0')}>
                      <IntlMessages id="transactions.transaction-agent" />
                    </h4>
                  </div>
                </div>
              </Col>
...
const mapActionsToProps = {
  fetchAgentsTransaction,
};

export default connect(mapStateToProps, mapActionsToProps)(AgentHistory);
