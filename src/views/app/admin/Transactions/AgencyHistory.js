...
import { fetchAgenciesTransaction } from '../../../../redux/transaction/actions';
import CustomSpinner from '../../../../components/customSpinner';
import DataTablePagination from '../../../../components/DatatablePagination';

class AgencyHistory extends Component {
  state = {
    tab: 0,
  ...
  componentDidMount() {
    ...
    this.props.fetchAgenciesTransaction();
  }
                ...
                >
                  ...
                  >
                    <h4 className={classNames('mb-0')}>
                      <IntlMessages id="transactions.transaction-agency" />
                    </h4>
                  </div>
                </div>
              </Col>
...
const mapActionsToProps = {
  fetchAgenciesTransaction,
};

export default connect(mapStateToProps, mapActionsToProps)(AgencyHistory);
