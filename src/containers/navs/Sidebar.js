...
import { data, dataAgency, dataAgencyNoAuth } from '../../constants/menu';
...
class Sidebar extends Component {
  ...
  getMenu() {
    const { roles, approved } = this.props;
    switch (roles[0]) {
      case 'agency':
        return approved ? dataAgency : dataAgencyNoAuth;
      case 'admin':
        return data;
      default:
        return [];
